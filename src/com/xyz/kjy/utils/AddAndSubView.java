...
public class AddAndSubView extends LinearLayout
{
	...
	private void initialise()
	{
		...
		subButton.setTextSize(TypedValue.COMPLEX_UNIT_SP,22);
		//设置输入类型为数字
		...
		setButtonBgColor(Color.parseColor("#ffffff"),Color.parseColor("#ffffff"));
	}
		...
		public void onClick(View v)
		{
			...
			} else
			{
				if (v.getTag().equals("+"))
				{
					...
					{
						num--;
						Toast.makeText(context, "数字不能小于0",
								Toast.LENGTH_SHORT).show();
					}
					if(num>99){
						num--;
						Toast.makeText(context, "数字不能大于99",
								Toast.LENGTH_SHORT).show();
					}
					else
					{
